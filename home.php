...
<?php if(!isset($_GET['q'])): ?>
<h1>Selamat Datang <?php echo $_settings->info('name') ?></h1>
<?php else: ?>
<h1>Carikan? <b>"<?= $_GET['q'] ?>"</b> Kata Kunci</h1>
<?php endif; ?>
    ...
    <div class="card-body">
        <div class="container-fluid">
                    ...
                    <div class="col-auto flex-grow-1">
                        <div class="col-12">
                            ...
                            <div class="w-100 d-flex justify-content-between align-items-top">
                                <span class="text-muted">Kategori <?= ucwords(isset($category_arr[$row['category_id']]) ? $category_arr[$row['category_id']] : "") ?></span>
                                <div>
                                    <span class="text-muted mr-2">Dibuat Oleh <?= isset($user_arr[$row['user_id']]) ? $user_arr[$row['user_id']] : 'N/A' ?></span>
            ...
            <?php if($magazines->num_rows < 1): ?>
                <center><span class="text-muted">Tidak Tersedia Majalah.</span></center>
            <?php endif; ?>
            </div>
        </div>
    </div>
