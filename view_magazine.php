    ...
    <div class="card card-outline card-primary">
        ...
        <div class="card-body">
            <div class="container-fluid">
                ...
                <h3 class="text-muted">Comment/s:</h3>
                <?php 
                    $cwhere = " and status = 1";
                ...
                <div class="bg-gradient-light shadow px-2 py-3">
                    <h3 class="text-purple">Posting Komentar Anda</h3>
                    <form action="" id="comment-form">
                        ...
                        <div class="form-group text-right">
                            <button class="btn btn-primary">Simpan Comment</button>
                        </div>
                ...
                success:function(resp){
                    if(resp.status == 'success'){
                        ...
                        location.reload();
                            ...
                            alert("Your comment was successfully submitted and will be visible after verification.")
                            location.reload();
                        }
                    }else if(!!resp.msg){
