<style>
  /* Navbar styling */
  nav.main-header {
    background-color: #295829; /* Warna hijau tua */
    padding: 10px 0;
...
<!-- Navbar -->
      ...
      <nav class="bg-dark w-100 px-2 py-1 position-fixed top-0" id="login-nav">
        <div class="text-right">
          <a href="./admin" class="mx-2">ADMINISTRATOR</a>
          <span class="mx-2">Naufal <?= $_settings->userdata('username') ?></span>
          <span class="mx-1"><a href="<?= base_url.'classes/Login.php?f=logout' ?>"><i class="fa fa-power-off"></i></a></span>
        </div>
      </nav>
      <?php endif; ?>
      <nav class="main-header navbar navbar-expand navbar-light border border-light border-top-0 border-left-0 border-right-0 navbar-light text-sm bg-green text-light" id='top-Nav'>
