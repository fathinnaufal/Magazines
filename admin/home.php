<h1>Selamat Datang di <?php echo $_settings->info('name') ?></h1>
...
<div class="row">
    <div class="col-12 col-sm-12 col-md-6 col-lg-3">
        <div class="info-box bg-light shadow">
            ...
            <span class="info-box-text">Semua Majalah</span>
    ...
    <div class="col-12 col-sm-12 col-md-6 col-lg-3">
        <div class="info-box bg-light shadow">
            ...
            <div class="info-box-content">
            <span class="info-box-text">Terpasang</span>
            <span class="info-box-number text-right">
                <?php 
    ...
    <div class="col-12 col-sm-12 col-md-6 col-lg-3">
        <div class="info-box bg-light shadow">
            ...
            <div class="info-box-content">
            <span class="info-box-text">Tidak Terpasang</span>
            <span class="info-box-number text-right">
                <?php 
    ...
    <div class="col-12 col-sm-12 col-md-6 col-lg-3">
        <div class="info-box bg-light shadow">
            ...
            <div class="info-box-content">
            <span class="info-box-text">Pengguna tidak terverifikasi</span>
            <span class="info-box-number text-right">
                <?php 
