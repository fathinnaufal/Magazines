...
<body class="hold-transition ">
  ...
  <div class="h-100 d-flex align-items-center w-100" id="login">
    ...
    <div class="col-5 h-100 bg-gradient" style="background-color: #006400;">
    <div class="d-flex w-100 h-100 justify-content-center align-items-center" style="background-color: #006400;">
        <div class="card col-md-4 col-lg-8 card-outline card-primary">
          ...
          <div class="card-body">
            <form id="login-frm" action="" method="post">
              ...
              <div class="row">
                <div class="col-8">
                  <a href="<?php echo base_url ?>">Ke Website Unsia Majalah</a>
                </div>
                <!-- /.col -->
                <div class="col-4">
              ...
              <div class="row">
                <div class="col-md-12 text-center">
                  <a href="./register.php">Buat Akun Lain</a>
                </div>
              </div>
            </form>
          </div>
